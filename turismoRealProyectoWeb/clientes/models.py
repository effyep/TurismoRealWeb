...
class Boleta(models.Model):
    ...
    comprobante = models.BinaryField(blank=True, null=True)
...
class Reservas(models.Model):
    ...
    estadoreserva = models.BooleanField(db_column='estadoReserva', blank=True, null=True)  # Field name made lowercase.
